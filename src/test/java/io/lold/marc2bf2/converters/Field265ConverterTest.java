...
public class Field265ConverterTest {
    Field265Converter converter;
    private Model model;
    ...
    public void setUp() {
        ...
        converter = new Field265Converter(model, record);
    }
    ...
    @Test
    public void testConvert265() throws Exception {
        String q = String.join("\n"
                ...
                , "WHERE { "
                , "  ?w a bf:Instance ."
                , "  ?w bf:acquisitionSource \"U.S. Geological Survey, Reston, Va. 22091\" ."
                , "}");
