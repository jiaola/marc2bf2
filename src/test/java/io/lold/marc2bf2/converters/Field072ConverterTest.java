...
public class Field072ConverterTest {
    Field072Converter converter;
    private Model model;
    ...
    public void setUp() throws Exception {
        ...
        converter = new Field072Converter(model, record);
    }
    ...
    public void testConvert() throws Exception {
        ...
        for (DataField field: fields) {
            if (field.getTag().equals("072") && field.getIndicator2() == '7') {
