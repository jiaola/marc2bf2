...
public class Field055ConverterTest {
    Field055Converter converter;
    private Model model;
    ...
    public void setUp() throws Exception {
        ...
        converter = new Field055Converter(model, record);
    }
    ...
    public void testConvert() throws Exception {
        String q = String.join("\n"
                ...
                , "SELECT ?x  "
                , "WHERE { "
                , "  ?x rdf:type bf:ClassificationLcc ."
                , "  ?x bf:source ?s ."
                , "  ?s rdfs:label \"Library and Archives Canada\" ."
                , "  ?x bf:classificationPortion \"F5050 .2\" ."
                , "}");
