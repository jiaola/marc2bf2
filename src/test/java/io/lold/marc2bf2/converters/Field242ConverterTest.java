...
public class Field242ConverterTest {
    Field242Converter converter;
    private Model model;
    ...
    public static Record[] records() {
        return TestUtils.readTestRecords("ConvSpec-200-247not240-Titles/marc242.xml");
    }
    ...
    public void setUp() {
        ...
        converter = new Field242Converter(model, record);
    }
    ...
    @Test
    public void testConvert242() throws Exception {
