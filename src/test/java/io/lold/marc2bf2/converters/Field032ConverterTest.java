...
public class Field032ConverterTest {
    Field032Converter converter;
    private Model model;
    ...
    public void setUp() {
        ...
        converter = new Field032Converter(model, record);
    }
    ...
    public void testConvert() throws Exception {
        String q = String.join("\n"
                ...
                , "WHERE { "
                , "  ?w bf:identifiedBy ?a ."
                , "  ?a rdf:type bf:PostalRegistration ."
                , "  ?a rdf:value \"686310\" ."
                , "}");
        List<DataField> fields = record.getDataFields();
        for (DataField field: fields) {
            if (field.getTag().equals("032")) {
