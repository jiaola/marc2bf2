...
public class Field047ConverterTest {
    Field047Converter converter;
    private Model model;
    ...
    public void setUp() {
        ...
        converter = new Field047Converter(model, record);
    }
    ...
    public void testConvert() throws Exception {
        ...
        for (DataField field: fields) {
            if (field.getTag().equals("047")) {
                ...
                if (field.getIndicator2() == ' ') {
                    ResultSet results = TestUtils.sparql(String.format(q, "marcmuscomp"), model);
                    assertTrue(results.hasNext());
                } else if (field.getIndicator2() == '7') {
                    ResultSet results = TestUtils.sparql(String.format(q, field.getSubfieldsAsString("2")), model);
                    assertTrue(results.hasNext());
                }
            } else {
