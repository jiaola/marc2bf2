...
public class Field026ConverterTest {
    Field026Converter converter;
    private Model model;
    ...
    public void setUp() {
        ...
        converter = new Field026Converter(model, record);
    }
    ...
    public void testConvert() throws Exception {
        String q = String.join("\n"
                ...
                , "WHERE { "
                , "  ?w bf:identifiedBy ?a ."
                , "  ?a rdf:type bf:Fingerprint ."
                , "  ?a rdf:value \"dete nkck vess lodo 3 Anno Domini MDCXXXVI 3\" ."
                , "  ?a bflc:applicableInstitution ?i ."
                , "  ?i bf:code \"UkCU\" ."
                , "}");
        List<DataField> fields = record.getDataFields();
        for (DataField field: fields) {
            if (field.getTag().equals("026")) {
