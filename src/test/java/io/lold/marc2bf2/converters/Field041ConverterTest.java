...
public class Field041ConverterTest {
    Field041Converter converter;
    private Model model;
    ...
    public void setUp() {
        ...
        converter = new Field041Converter(model, record);
    }
    ...
    @Test
    public void testConvertNote() throws Exception {
    ...
    @Test
    public void testConvertInd2() throws Exception {
        String q = String.join("\n"
                , "PREFIX bf: <" + BIB_FRAME.getURI() + ">"
                , "PREFIX rdf: <" + RDF.getURI() + ">"
                , "PREFIX rdfs: <" + RDFS.getURI() + ">"
                ...
                , "  ?x bf:language ?y ."
                , "  ?y rdfs:label \"%1s\" ."
                , "  ?y bf:part \"accompanying material\""
                , "}");
        List<DataField> fields = record.getDataFields();
        for (DataField field : fields) {
            if (field.getTag().equals("041")) {
