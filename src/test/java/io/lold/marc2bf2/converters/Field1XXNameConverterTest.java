...
public class Field1XXNameConverterTest {
    Field1XXNameConverter converter;
    private Model model;
    ...
    public void setUp() {
        ...
        converter = new Field1XXNameConverter(model, record);
    }
    ...
    public void testConvert100() throws Exception {
        String q = String.join("\n"
                ...
                , "  ?a rdf:value \"310008891\" ."
                , "}");
        List<DataField> fields = record.getDataFields();
        for (int i = 0; i < fields.size(); i++) {
            DataField field = fields.get(i);
            converter.setFieldIndex(i);
            if (field.getTag().equals("100")) {
