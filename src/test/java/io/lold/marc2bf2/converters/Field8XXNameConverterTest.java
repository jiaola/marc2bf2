...
public class Field8XXNameConverterTest {
    Field8XXNameConverter converter;
    private Model model;
    ...
    public void setUp() {
        ...
        converter = new Field8XXNameConverter(model, record);
    }
    ...
    @Test
    public void testConvert800() throws Exception {
        String q = String.join("\n"
                ...
                , "WHERE { "
                , "  ?a rdf:type bf:Work ."
                , "  ?a bf:seriesEnumeration \"pt. 2\" ."
                , "}");
        List<DataField> fields = record.getDataFields();
        for (int i = 0; i < fields.size(); i++) {
            DataField field = fields.get(i);
            converter.setFieldIndex(i);
            if (field.getTag().equals("800")) {
