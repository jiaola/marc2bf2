...
public class Field7XXNameConverterTest {
    Field7XXNameConverter converter;
    private Model model;
    ...
    public void setUp() {
        ...
        converter = new Field7XXNameConverter(model, record);
    }
    ...
    @Test
    public void testConvert700() throws Exception {
        String q = String.join("\n"
                ...
                , "  ?w bf:relatedTo ?a ."
                , "  ?a rdf:type bf:Work ."
                , "  ?a rdfs:label \"Alice's adventures in Wonderland\" ."
                , "}");
        List<DataField> fields = record.getDataFields();
        for (int i = 0; i < fields.size(); i++) {
            DataField field = fields.get(i);
            converter.setFieldIndex(i);
            if (field.getTag().equals("700")) {
