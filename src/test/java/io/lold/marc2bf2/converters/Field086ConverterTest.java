...
public class Field086ConverterTest {
    Field086Converter converter;
    private Model model;
    ...
    public void setUp() throws Exception {
        ...
        converter = new Field086Converter(model, record);
    }
    ...
    public void testConvert() throws Exception {
        ...
        for (DataField field: fields) {
            if (field.getTag().equals("086") && field.getIndicator1() == '0') {
