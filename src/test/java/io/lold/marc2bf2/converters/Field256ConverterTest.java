...
public class Field256ConverterTest {
    Field256Converter converter;
    private Model model;
    ...
    public void setUp() {
        ...
        converter = new Field256Converter(model, record);
    }
    ...
    @Test
    public void testConvert256() throws Exception {
        String q = String.join("\n"
                ...
                , "  ?w bf:note ?n ."
                , "  ?n a bf:Note ."
                , "  ?n rdfs:label \"Computer data (2 files : 876,000, 775,000 records)\" . "
                , "  ?n bf:noteType \"Computer file characteristics\" . "
                , "}");
