...
public class Field247ConverterTest {
    Field247Converter converter;
    private Model model;
    ...
    public static Record[] records() {
        return TestUtils.readTestRecords("ConvSpec-200-247not240-Titles/marc247.xml");
    }
    ...
    public void setUp() {
        ...
        converter = new Field247Converter(model, record);
    }
    ...
    @Test
    public void testConvert247() throws Exception {
