...
public class Field262ConverterTest {
    Field262Converter converter;
    private Model model;
    ...
    public void setUp() {
        ...
        converter = new Field262Converter(model, record);
    }
    ...
    @Test
    public void testConvert262() throws Exception {
        String q = String.join("\n"
                ...
                , "WHERE { "
                , "  ?w a bf:Instance ."
                , "  ?w bf:provisionActivityStatement \"Louisville, KY., Louisville Orchestra, [1967]\" ."
                , "}");
