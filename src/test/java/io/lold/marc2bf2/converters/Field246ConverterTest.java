...
public class Field246ConverterTest {
    Field246Converter converter;
    private Model model;
    ...
    public static Record[] records() {
        return TestUtils.readTestRecords("ConvSpec-200-247not240-Titles/marc246.xml");
    }
    ...
    public void setUp() {
        ...
        converter = new Field246Converter(model, record);
    }
    ...
    @Test
    public void testConvert246() throws Exception {
