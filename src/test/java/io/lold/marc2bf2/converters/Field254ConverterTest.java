...
public class Field254ConverterTest {
    Field254Converter converter;
    private Model model;
    ...
    public void setUp() {
        ...
        converter = new Field254Converter(model, record);
    }
    ...
    @Test
    public void testConvert254() throws Exception {
        String q = String.join("\n"
                ...
                , "  ?w bf:note ?n ."
                , "  ?n a bf:Note ."
                , "  ?n rdfs:label \"Full score\" . "
                , "  ?n bf:noteType \"Musical presentation\" . "
                , "}");
        List<DataField> fields = record.getDataFields();
        for (int i = 0; i < fields.size(); i++) {
            DataField field = fields.get(i);
            converter.setFieldIndex(i);
            if (field.getTag().equals("254")) {
