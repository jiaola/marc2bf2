...
public class Field033ConverterTest {
    Field033Converter converter;
    private Model model;
    ...
    public void setUp() {
        ...
        converter = new Field033Converter(model, record);
    }
    ...
    public void testConvert() throws Exception {
        String q = String.join("\n"
                ...
                , "SELECT ?w  "
                , "WHERE { "
                , "  ?w bf:date \"1978-09-10T20:00:00-04:00/1978-09-14T20:00:00-04:00\"^^<http://id.loc.gov/datatypes/edtf> ."
                , "}");
        ...
        for (DataField field: fields) {
            if (field.getTag().equals("033")) {
                ...
                if (field.getIndicator1() == '2') {
                    ResultSet rs = TestUtils.sparql(q, model);
                    assertTrue(rs.hasNext());
                } else if (field.getIndicator1() == '0') {
                    ResultSet rs = TestUtils.sparql(q, model);
                    assertTrue(rs.hasNext());
                }
            } else {
