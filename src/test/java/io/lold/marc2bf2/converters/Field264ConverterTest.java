...
public class Field264ConverterTest {
    Field264Converter converter;
    private Model model;
    ...
    public void setUp() {
        ...
        converter = new Field264Converter(model, record);
    }
    ...
    @Test
    public void testConvert264() throws Exception {
