...
public class Field042ConverterTest {
    Field042Converter converter;
    private Model model;
    ...
    public void setUp() {
        ...
        converter = new Field042Converter(model, record);
    }
    ...
    public void testConvert() throws Exception {
        String q = String.join("\n"
                ...
                , "SELECT ?x  "
                , "WHERE { "
                , "  ?x bf:descriptionAuthentication <http://id.loc.gov/vocabulary/marcauthen/%1s> ."
                , "}");
