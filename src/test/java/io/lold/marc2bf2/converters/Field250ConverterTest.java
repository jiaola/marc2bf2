...
public class Field250ConverterTest {
    Field250Converter converter;
    private Model model;
    ...
    public void setUp() {
        ...
        converter = new Field250Converter(model, record);
    }
    ...
    @Test
    public void testConvert250() throws Exception {
        String q = String.join("\n"
                ...
                , "WHERE { "
                , "  ?w a bf:Instance ."
                , "  ?w bf:editionStatement \"3rd draft / edited by Paul Watson\" ."
                , "}");
