...
public class Field222ConverterTest {
    Field222Converter converter;
    private Model model;
    ...
    public static Record[] records() {
        return TestUtils.readTestRecords("ConvSpec-200-247not240-Titles/marc222.xml");
    }
    ...
    public void setUp() {
        ...
        converter = new Field222Converter(model, record);
    }
    ...
    @Test
    public void testConvert222() throws Exception {
