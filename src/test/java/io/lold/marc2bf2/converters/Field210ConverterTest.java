...
public class Field210ConverterTest {
    Field210Converter converter;
    private Model model;
    ...
    public static Record[] records() {
        return TestUtils.readTestRecords("ConvSpec-200-247not240-Titles/marc210.xml");
    }
    ...
    public void setUp() {
        ...
        converter = new Field210Converter(model, record);
    }
    ...
    @Test
    public void testConvert210() throws Exception {
        String q = String.join("\n"
                ...
                , "  ?w bf:title ?a ."
                , "  ?a rdf:type bf:Title ."
                , "  ?a rdf:type bf:VariantTitle ."
                , "  ?a rdf:type bf:AbbreviatedTitle ."
                , "}");
        List<DataField> fields = record.getDataFields();
        for (int i = 0; i < fields.size(); i++) {
            DataField field = fields.get(i);
            converter.setFieldIndex(i);
            if (field.getTag().equals("210")) {
