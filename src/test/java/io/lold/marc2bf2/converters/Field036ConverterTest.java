...
public class Field036ConverterTest {
    Field036Converter converter;
    private Model model;
    ...
    public void setUp() {
        ...
        converter = new Field036Converter(model, record);
    }
    ...
    public void testConvert() throws Exception {
        String q = String.join("\n"
                ...
                , "WHERE { "
                , "  ?w bf:identifiedBy ?a ."
                , "  ?a rdf:type bf:StudyNumber ."
                , "  ?a rdf:value \"CNRS 84115\" ."
                , "}");
        List<DataField> fields = record.getDataFields();
        for (DataField field: fields) {
            if (field.getTag().equals("036")) {
