...
public class Field028ConverterTest {
    Field028Converter converter;
    private Model model;
    ...
    public void setUp() {
        ...
        converter = new Field028Converter(model, record);
    }
    ...
    public void testConvert() throws Exception {
        String q = String.join("\n"
                ...
                , "WHERE { "
                , "  ?w bf:identifiedBy ?a ."
                , "  ?a rdf:type bf:AudioIssueNumber ."
                , "  ?a rdf:value \"440 073 033-9\" ."
                , "}");
        List<DataField> fields = record.getDataFields();
        for (DataField field: fields) {
            if (field.getTag().equals("028")) {
