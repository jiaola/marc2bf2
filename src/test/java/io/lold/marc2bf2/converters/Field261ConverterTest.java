...
public class Field261ConverterTest {
    Field261Converter converter;
    private Model model;
    ...
    public void setUp() {
        ...
        converter = new Field261Converter(model, record);
    }
    ...
    @Test
    public void testConvert261() throws Exception {
        String q = String.join("\n"
                ...
                , "  ?n a bf:Manufacture ."
                , "  ?n a bf:ProvisionActivity ."
                , "  ?n bf:agent ?a ."
                , "  ?a a bf:Agent ."
                , "  ?a rdfs:label \"Made by D.C. Chipperfield\" . "
                , "}");
