...
public class Field263ConverterTest {
    Field263Converter converter;
    private Model model;
    ...
    public void setUp() {
        ...
        converter = new Field263Converter(model, record);
    }
    ...
    @Test
    public void testConvert263() throws Exception {
        String q = String.join("\n"
                ...
                , "SELECT ?w  "
                , "WHERE { "
                , "  ?w bflc:projectedProvisionDate \"1999-XX\"^^<http://id.loc.gov/datatypes/edtf> ."
                , "}");
