...
public class Field243ConverterTest {
    Field243Converter converter;
    private Model model;
    ...
    public static Record[] records() {
        return TestUtils.readTestRecords("ConvSpec-200-247not240-Titles/marc243.xml");
    }
    ...
    public void setUp() {
        ...
        converter = new Field243Converter(model, record);
    }
    ...
    @Test
    public void testConvert243() throws Exception {
