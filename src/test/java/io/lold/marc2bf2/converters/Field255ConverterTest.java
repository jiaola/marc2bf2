...
public class Field255ConverterTest {
    Field255Converter converter;
    private Model model;
    ...
    public void setUp() {
        ...
        converter = new Field255Converter(model, record);
    }
    ...
    @Test
    public void testConvert255() throws Exception {
        String q = String.join("\n"
                ...
                , "  ?w bf:scale ?n ."
                , "  ?n a bf:Scale ."
                , "  ?n rdfs:label \"Scale [ca. 1:500,000]\" . "
                , "  ?w bf:cartographicAttributes ?c ."
                , "  ?c a bf:Cartographic ."
                , "  ?c bf:equinox \"eq. 1980\" ."
                , "}");
