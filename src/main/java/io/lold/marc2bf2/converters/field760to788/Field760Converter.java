...
public class Field760Converter extends FieldConverter {
    ...
    public Resource createInstance(DataField field) {
        ...
        for (Subfield sf: field.getSubfields('h')) {
            resource.addProperty(BIB_FRAME.part, createLabeledResource(BIB_FRAME.Extent, sf.getData(), lang));
        }
    ...
    private Resource createIdentifier(Resource type, String value) {
