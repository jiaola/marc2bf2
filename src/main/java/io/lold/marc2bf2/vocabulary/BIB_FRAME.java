...
public class BIB_FRAME {
    ...
    static {
        ...
        Cartographic = m.createResource(BIB_FRAME.NAMESPACE + "Cartographic");
        ...
        Distribution = m.createResource(BIB_FRAME.NAMESPACE + "Distribution");
        ...
        FontSize = m.createResource(BIB_FRAME.NAMESPACE + "FontSize");
        Generation = m.createResource(BIB_FRAME.NAMESPACE + "Generation");
        GenreForm = m.createResource(BIB_FRAME.NAMESPACE + "GenreForm");
        Illustration = m.createResource(BIB_FRAME.NAMESPACE + "Illustration");
        ...
        Place = m.createResource(BIB_FRAME.NAMESPACE + "Place");
        ...
        Print = m.createResource(BIB_FRAME.NAMESPACE + "Print");
        Production = m.createResource(BIB_FRAME.NAMESPACE + "Production");
        ProjectionCharacteristic = m.createResource(BIB_FRAME.NAMESPACE + "ProjectionCharacteristic");
        ProvisionActivity = m.createResource(BIB_FRAME.NAMESPACE + "ProvisionActivity");
        Publication = m.createResource(BIB_FRAME.NAMESPACE + "Publication");
        ...
        copyrightDate = m.createProperty(BIB_FRAME.NAMESPACE, "copyrightDate");
        creationDate = m.createProperty(BIB_FRAME.NAMESPACE, "creationDate");
        date = m.createProperty(BIB_FRAME.NAMESPACE, "date");
        ...
        fontSize = m.createProperty(BIB_FRAME.NAMESPACE, "fontSize");
        ...
        illustrativeContent = m.createProperty(BIB_FRAME.NAMESPACE, "illustrativeContent");
        ...
        place = m.createProperty(BIB_FRAME.NAMESPACE, "place");
        projection = m.createProperty(BIB_FRAME.NAMESPACE, "projection");
        projectionCharacteristic = m.createProperty(BIB_FRAME.NAMESPACE, "projectionCharacteristic");
        provisionActivity = m.createProperty(BIB_FRAME.NAMESPACE, "provisionActivity");
